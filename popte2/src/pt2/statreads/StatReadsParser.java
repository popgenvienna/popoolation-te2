...
public class StatReadsParser {
		...
		public static void parseCommandline(LinkedList<String> args)
		{
			...
			StatReadsFramework pfp =new StatReadsFramework(inputFiles,outputFile,hierFile,mapQual,logger);
			pfp.run();
		}
		...
		public static void printHelp()
		{
			...
			sb.append("computes mapping statistics; reads mapping to TEs and different reference chromosomes\n\n");
